...
export const getSurveyReport = async (req: AuthRequest, res: Response) => {
    try {
        ...
        let matchingResponseIds: number[] | null = null;
        ...
        const whereClause: any = { surveyId: Number(id) };
        ...
        const questionStats = survey.questions.map((question: any) => {
            ...
            if (question.type === 'SINGLE_CHOICE' || question.type === 'MULTIPLE_CHOICE') {
                ...
                const getOptionDetails = (opt: any): { text: string, value: string } => {
...
export const getSurveyHeatmap = async (req: Request, res: Response) => {
    const { id } = req.params;
    const { filterQuestionId, filterAnswer } = req.query;
    ...
    try {
        ...
        responses.forEach(r => {
            ...
            const locData = r.location as any;
            ...
            if (filterQuestionId && filterAnswer) {
                ...
                const answer = r.data ? (r.data as any)[qIdStr] : null;
